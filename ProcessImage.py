...
def initializeSlidingWindows(binaryImage):
    ...
    print("binaryImage.shape:", binaryImage.shape, ", type:", binaryImage.dtype)
...
def processImage(binaryImage, left_fit, right_fit):
    ...
    print("nonzeroy.shape:", nonzeroy.shape, ", type:", nonzeroy.dtype)
    nonzerox = np.array(nonzero[1])
    print("nonzerox.shape:", nonzerox.shape, ", type:", nonzerox.dtype)
    margin = 100
    left_laneX = left_fit[0]*nonzeroy**2 + left_fit[1]*nonzeroy + left_fit[2]
    print("left_laneX.shape:", left_laneX.shape, ", type:", left_laneX.dtype)
...
def testProcessImage():
    ...
    for videoFrameName, videoFrameIndex in zip(videoImages, range(0, len(videoImages))):
        ...
        print("videoFrameName: ",videoFrameName, ", visualizationImage.shape:", visualizationImage.shape, ", type:", visualizationImage.dtype)
